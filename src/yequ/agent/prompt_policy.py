...
def render_agent_system_prompt(capability_context_text: str) -> str:
    ...
    return (
        ...
        "node, source path, or landing path. If any of these intent slots are "
        "missing or ambiguous, ask the user for the missing information before "
        "calling transfer.create.\n"
