...
async def test_four_safe_read_tools_concurrent_created_events(client: AsyncClient):
    ...
    fake.add_functions([
        ...
        AgentFunction(name="system.metrics.snapshot", description="metrics", risk="safe", effect="read"),
        AgentFunction(name="system.disk.detail", description="disk", risk="safe", effect="read"),
        AgentFunction(name="system.processes.list", description="processes", risk="safe", effect="read"),
    ])
    fake.set_sequence([
...
async def test_write_tool_not_concurrent_with_read_tools(client: AsyncClient):
    ...
    fake.add_functions([
        ...
        AgentFunction(name="system.metrics.snapshot", description="read", risk="safe", effect="read"),
        AgentFunction(
