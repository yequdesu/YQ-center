...
| `docs/todos/2026-07-01-transfer-rclone-center-plan.md` | Center 传输主路径从 croc 切换到 rclone SFTP 的详细修改计划。 |
| `docs/todos/2026-07-01-transfer-rclone-winnode-plan.md` | Windows Node 删除 croc 并实现 rclone SFTP transfer capability 的详细修改计划。 |
| `docs/todos/2026-07-01-transfer-rclone-linuxnode-plan.md` | Linux Node 删除 croc 并实现 rclone SFTP transfer capability 的详细修改计划。 |
